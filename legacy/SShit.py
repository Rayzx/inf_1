...
def update():
    ...
    """
    dx1=((x1-100*k)*math.sin(i/180*3.14))+100*k
    dy1=((y1-150*k)*math.cos(i/180*3.14))+150*k
    dx2=((x2-100*k)*math.sin(i/180*3.14))*(-1)+100*k
    dy2=((y2-150*k)*math.cos(i/180*3.14))+150*k
    changeCoords(obj,[(dx1,dy1),(dx2,dy2)])
    """
###
